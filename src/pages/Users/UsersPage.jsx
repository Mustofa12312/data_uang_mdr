...
export default function UsersPage() {
  ...
  async function handleSave() {
    ...
    try {
      if (editItem) {
        // Update profile (nama, role, instansi)
  ...
  async function handleResetPassword() {
    ...
    try {
      ...
      // mengirim reset email (lebih aman untuk production)
      ...
      // Fallback: tampilkan info karena Admin API butuh service_role key
      showToast('Kirim email reset password berhasil (cek kotak masuk)', 'success')
      setResetModal(false)
  ...
  return (
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="card p-4 bg-blue-50 border border-blue-200 text-blue-700 text-xs leading-relaxed">
        <strong>ℹ️ Cara menambah user:</strong> User baru akan menerima email konfirmasi dari Supabase.
        Setelah konfirmasi, role dan instansi dapat diatur dari halaman ini.
