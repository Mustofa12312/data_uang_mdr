...
export default function NotificationPanel() {
  ...
  // Ambil transaksi terbaru sebagai notifikasi
  async function fetchNotifs() {
    try {
      let q = supabase
        .from('transaksi')
        .select('id, uraian, nominal, jenis, tanggal, created_at, instansi:instansi_id(nama_instansi)')
  ...
  useEffect(() => {
    ...
    // Realtime subscription — auto update saat ada transaksi baru
    const channel = supabase
      .channel('notif-transaksi')
